        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="main-card mb-3 card">
                    <div class="card-body"><h5 class="card-title">Request In Progress</h5>
                        ...
                        <table class="mb-0 display request table table-bordered" id="datatable">
                            ...
                            <tbody>
                                <?php 
                                $i=0;
                                foreach($totalInProgress as $row): $i++;
                                ?>       
                                <tr>
                                    <th scope="row"><?= $i ?></th>
                                    <td>
                    ...
                    <div class="d-block text-center card-footer">
                        <form action="<?= base_url('admin/export/inProgress')?>" method="post">
